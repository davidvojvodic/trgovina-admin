...
export async function POST(req: Request, { params }: { params: { storeId: string } }) {
    try {
        ...
        // Step 10: Create a new color with the specified 'name', 'value', and 'storeId'
        ...
        // Step 11: Return a JSON response containing the newly created color
...
export async function GET(req: Request, { params }: { params: { storeId: string } }) {
    try {
        ...
        // Step 2: Find all colors with the specified 'storeId' in the database using prismadb
        ...
        // Step 3: Return a JSON response containing the retrieved colors
